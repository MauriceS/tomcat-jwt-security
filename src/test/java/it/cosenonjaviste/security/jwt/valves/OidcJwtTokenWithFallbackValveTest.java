...
public class OidcJwtTokenWithFallbackValveTest {
    ...
    private OidcJwtTokenWithFallbackValve jwtValve = new OidcJwtTokenWithFallbackValve();
    ...
    @Test
    public void shouldNotFailAuthBecauseOfBasicValueSet() throws Exception {
        mockSecurityConstraints();
        when(request.getHeader("Authorization")).thenReturn(
